      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-5 leading-tight">
            Build Websites With
            <span
              className="block bg-linear-to-r  from-white to-zinc-400 bg-clip-400 
        ...
        <div className="mb-14 ">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full h-56 p-6 rounded-3xl bg-black/60 border border-white/10 outline-none resize-none text-sm leading-relaxed
