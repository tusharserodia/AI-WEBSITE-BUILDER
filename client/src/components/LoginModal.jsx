...
import image1 from "../../public/Google_image1.webp";
            ...
            {open &&
                <motion.div
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md p-1px rounded-3xl bg-linear-to-br from-purple-500/10 via-blue-500/30 to-transparent "
                    ...
                    >
                     <div className="relative rounded-3xl bg-[#0b0b0b] border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
                        ...
                        transition text-lg" onClick={onClose}>X</button>
