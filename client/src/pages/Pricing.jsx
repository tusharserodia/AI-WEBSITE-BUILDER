import { ArrowBigLeft, ArrowLeft, Check, Coins } from 'lucide-react'
...
const plans = [
    ...
    },
    {
        ...
        price: "₹499",
        credits: 500,
        description: "For Serious creatures & freelancers",
        features: [
            "Everything in Free",
            "Faster generation",
            "Edit & regeneration",
           ...
           {plans.map((p,i) => {
            return (
                ...
                <div className='flex items-end gap-1 mb-4'>
                    ...
                    <span className='text-sm text-zinc mb-1'>/one-time</span>
                </div>
