...
import { ArrowLeft, Check, Rocket, Server, Share, Share2 } from 'lucide-react';
                  ...
                  transition flex flex-col'>
                      ...
                      <div className='p-5 flex flex-col gap-4 flex-1'>
                        ...
                        <p className='text-xs text-zinc-400'>Last Updated {" "}
                          {new Date(w.updatedAt).toLocaleDateString()} </p>

                         {!w.deployed ? (
                          <button className='mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold
                          bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition' onClick={() =>handleDeploy(w._id)}>
                         ...
                         (<motion.button
                          ...
                          rounded-xl text-xm font-medium transition-all ${copied ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/30":
